...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="ifreTestController.do?doUpdate">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
		     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt" value='${ifreTestPage.name}'>
			...
			<td class="value">
		     	 <input id="pwd" name="pwd" type="text" style="width: 150px" class="inputxt" value='${ifreTestPage.pwd}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="t" name="t" type="text" style="width: 150px" class="inputxt" value='${ifreTestPage.t}'>
				<span class="Validform_checktip"></span>
