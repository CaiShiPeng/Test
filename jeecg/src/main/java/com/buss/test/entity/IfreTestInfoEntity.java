 ...
 */
@Entity
@Table(name = "ifre_test_info", schema = "")
@SuppressWarnings("serial")
public class IfreTestInfoEntity implements java.io.Serializable {
	/**主键*/
	 ...
	 */
	@Column(name ="I_ID",nullable=true,length=32)
